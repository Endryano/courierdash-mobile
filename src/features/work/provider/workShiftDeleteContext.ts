...
export type WorkShiftDeleteState = {status:'idle'}|{status:'confirming';summary:SafeShiftSummary}|{status:'deleting';summary:SafeShiftSummary}|{status:'success'}|{status:'recoverable_error';summary:SafeShiftSummary}|{status:'blocked';summary:SafeShiftSummary}|{status:'reconciliation_required';summary:SafeShiftSummary};
